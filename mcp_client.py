...
class PersistentMCPClient:
    ...
    def __init__(
        ...
        self._env_map = dict(env or {})
        self._params = StdioServerParameters(
            command=server_cmd[0],
            args=server_cmd[1:],
            env=self._env_map or None,
        )
    ...
    def pending_tests(self, txn: str): return self.call_tool("pending_tests", {"txn": txn})
    def disabled_txn_status(self, txn: str): return self.call_tool("disabled_txn_status", {"txn": txn})
